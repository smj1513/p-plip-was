...
public interface FreeBoardCommentDocsController {
    ...
    CommonResponse<Page<FreeBoardCommentResponse.Retrieve>> getComments(Long boardId, PageRequest pageRequest);
    ...
    CommonResponse<FreeBoardCommentResponse.Detail> postComment(Long boardId,
    ...
    CommonResponse<FreeBoardCommentResponse.Detail> updateComment(Long commentId,
